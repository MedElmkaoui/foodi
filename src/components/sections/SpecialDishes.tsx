            ...
            <div className="my-12 grid lg:grid-cols-3 gap-12 ">
                {
                    specialDishes.map((ele)=> (
                        <div key={ele.id} className="relative hover:bg-primary hover:text-white transition duration-1000 bg-white py-12 px-12 flex flex-col gap-3.5 items-center shadow-xl rounded-2xl">
                            ...
                            <div className="w-full space-y-3 my-3.5">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold xl:text-xl">{ele.rate}</span>
                                </div>
                            </div>

        ...
        <div className="w-full mx-auto">
            <nav className="w-full mx-auto h-[64px] flex items-center justify-between">
                ...
                <ul className="hidden lg:flex items-center gap-5 text-sm">
                    ...
                    <li className="flex  gap-1"><Link href={''}> Menu </Link> <RiArrowDropDownLine  size={20} className="text-primary " /> </li>
                    <li className="flex  gap-1"><Link href={''}> Services </Link> <RiArrowDropDownLine size={20}  className="text-primary " /></li>
            ...
            <div className="my-12 flex gap-12 flex-col-reverse lg:flex-row justify-between items-center">
                <div className="space-y-8 lg:space-y-12">
                    ...
                    <div className="flex gap-8 py-2.5 ">
                        <button className="bg-primary shadow-md shadow-primary text-white text-sm py-2.5 px-5 rounded-full">
                            Order Now
                        </button>
                ...
                <div className="relative ">
                    <div className="relative bg-primary w-[500px] h-[500px] rounded-full">
                    ...
                    <div className="z-1 absolute lg:-left-10 left-16 lg:bottom-2 -bottom-10 flex flex-col lg:flex-row gap-12">
